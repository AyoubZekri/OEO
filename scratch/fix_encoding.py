...
controller_path = r"d:\MyProject\KaidNews\OlympicOEOBakand\app\Http\Controllers\Api\EquipmentOperationController.php"
...
with open(controller_path, 'w', encoding='utf-8') as f:
    f.write(content)
print("Restored EquipmentOperationController.php with proper UTF-8 Arabic encoding")
